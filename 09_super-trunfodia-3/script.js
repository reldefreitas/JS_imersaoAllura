...
function atualizarQtdCartas(){
  ...
  var html = "Quantidade de Cartas: "+cartas.length
...
function jogar() {
    ...
    if (atributoSelecionado == undefined) {
      htmlResultado = '<p class="resultado-final">Perdeu. (nenhum atributo selecionado)</p>'
      pontosMaquina++
  ...
  if (cartas.length == 0){
    if (pontosJogador > pontosMaquina){
      alert("Você Venceu! Fim do jogo. "+"(Jogador "+pontosJogador+" / "+pontosMaquina+" Máquina)")
    } else if (pontosJogador < pontosMaquina){
      alert("Você Perdeu :( Fim do jogo. "+"(Jogador "+pontosJogador+" / "+pontosMaquina+" Máquina)")
    } else {
      alert("Empate! Fim do jogo. "+"(Jogador "+pontosJogador+" / "+pontosMaquina+" Máquina)")
    }
